...
public class CT02AdicionarExcluirMenu {
  ...
  @Test
  public void t2adicionarexcluirmenu() {
    ...
    driver.findElement(By.cssSelector(".col-xl-6:nth-child(1) .card-header svg")).click();
    driver.findElement(By.cssSelector("input:nth-child(2)")).click();
    driver.findElement(By.cssSelector("input:nth-child(2)")).sendKeys("novo");
    driver.findElement(By.cssSelector("input:nth-child(4)")).click();
    driver.findElement(By.cssSelector("div:nth-child(5) > button:nth-child(2)")).click();
    driver.findElement(By.cssSelector("tr:nth-child(2) .MuiSvgIcon-colorSecondary")).click();
    driver.findElement(By.cssSelector("input:nth-child(4)")).click();
    driver.findElement(By.cssSelector("input:nth-child(2)")).click();
    driver.findElement(By.cssSelector("input:nth-child(2)")).click();
    driver.findElement(By.cssSelector("input:nth-child(2)")).sendKeys("novo2");
    driver.findElement(By.cssSelector("div:nth-child(5) > button:nth-child(2)")).click();
    driver.findElement(By.cssSelector("tr:nth-child(2) .MuiSvgIcon-colorSecondary > path")).click();
    driver.findElement(By.cssSelector("input:nth-child(4)")).click();
    driver.findElement(By.cssSelector("div:nth-child(5) > button:nth-child(2)")).click();
    driver.findElement(By.cssSelector("tr:nth-child(2) .css-v608oq > path")).click();
  }
}
